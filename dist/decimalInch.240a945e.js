...
increaseResolution.addEventListener('click', function (event) {
  ...
  var target = document.getElementById('resolutionSlider');
  target.value = parseInt(target.value) + 1;
  processResolution(target.value);
});
decreaseResolution.addEventListener('click', function (event) {
  event.preventDefault();
  var target = document.getElementById('resolutionSlider');
  target.value = parseInt(target.value) - 1;
  processResolution(target.value);
...
function resolutionUpdate() {
  console.log("resolutionUpdate(): ".concat(this.value));
...
function lowerFraction() {
  ...
  var string = 'Smaller: ';
  string += inches > 1.0 ? "".concat(Math.trunc(inches).toString(), "-") : '';
  string += "".concat(fraction, "\" + ").concat((diff - decFraction).toFixed(3), "\"");
...
function upperFraction() {
  ...
  var string = 'Larger: ';
  string += inches > 1.0 ? "".concat(Math.trunc(inches).toString(), "-") : '';
  string += "".concat(fraction, "\" - ").concat((decFraction - diff).toFixed(3), "\"");
...
},{}]},{},["node_modules/parcel/src/builtins/hmr-runtime.js","decimalInch.js"], null)
//# sourceMappingURL=/decimalInch.240a945e.js.map